...
- [-] ~:custom-type~ entries for one-off group definitions [42%]
  - [X] Date/time related
  - [X] Effort
  - [ ] Misc
  - [ ] Priority
...
- [X] Widget: one-or-more
- [X] Widget: collapsible plist
...
#+begin_src emacs-lisp :results silent
  (defun tina/oom-value-to-internal (widget value)
  ...
  (defcustom tina/oom-list-test '(:meow (?G 42 ignore))
    "Test my custom widget with a list type"
    :type '(plist :options ((:meow (one-or-more (list character integer function))))))
#+end_src
